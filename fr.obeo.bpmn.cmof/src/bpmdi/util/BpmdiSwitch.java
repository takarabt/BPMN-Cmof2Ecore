 ...
 * @generated
 */
public class BpmdiSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BpmdiPackage modelPackage;
	...
	public BpmdiSwitch() {
		if (modelPackage == null) {
			modelPackage = BpmdiPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BpmdiPackage.BPMN_LABEL_STYLE: {
			...
			case BpmdiPackage.BPMN_DIAGRAM: {
