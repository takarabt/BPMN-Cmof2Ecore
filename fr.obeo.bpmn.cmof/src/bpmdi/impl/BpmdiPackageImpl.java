 ...
 * @generated
 */
public class BpmdiPackageImpl extends EPackageImpl implements BpmdiPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see bpmdi.BpmdiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BpmdiPackageImpl() {
		super(eNS_URI, BpmdiFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BpmdiPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BpmdiPackage init() {
		if (isInited) return (BpmdiPackage)EPackage.Registry.INSTANCE.getEPackage(BpmdiPackage.eNS_URI);

		// Obtain or create and register package
		BpmdiPackageImpl theBpmdiPackage = (BpmdiPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BpmdiPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BpmdiPackageImpl());
		...
		theBpmdiPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BpmdiPackage.eNS_URI, theBpmdiPackage);
		return theBpmdiPackage;
	}
	 ...
	 * @generated
	 */
	public BpmdiFactory getBpmdiFactory() {
		return (BpmdiFactory)getEFactoryInstance();
	}
