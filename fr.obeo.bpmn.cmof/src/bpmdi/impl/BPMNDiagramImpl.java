 ...
 * <ul>
 *   <li>{@link bpmdi.impl.BPMNDiagramImpl#getPlane <em>Plane</em>}</li>
 *   <li>{@link bpmdi.impl.BPMNDiagramImpl#getLabelStyle <em>Label Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNDiagramImpl extends DiagramImpl implements BPMNDiagram {
	...
	protected EClass eStaticClass() {
		return BpmdiPackage.Literals.BPMN_DIAGRAM;
	}
	...
	public NotificationChain basicSetPlane(BPMNPlane newPlane, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BpmdiPackage.BPMN_DIAGRAM__PLANE, oldPlane, newPlane);
	...
	public void setPlane(BPMNPlane newPlane) {
		if (newPlane != plane) {
			...
			if (plane != null)
				msgs = ((InternalEObject)plane).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BpmdiPackage.BPMN_DIAGRAM__PLANE, null, msgs);
			if (newPlane != null)
				msgs = ((InternalEObject)newPlane).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BpmdiPackage.BPMN_DIAGRAM__PLANE, null, msgs);
			msgs = basicSetPlane(newPlane, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmdiPackage.BPMN_DIAGRAM__PLANE, newPlane, newPlane));
	}
	...
	public EList<BPMNLabelStyle> getLabelStyle() {
		if (labelStyle == null) {
			labelStyle = new EObjectContainmentEList<BPMNLabelStyle>(BPMNLabelStyle.class, this, BpmdiPackage.BPMN_DIAGRAM__LABEL_STYLE);
		}
		return labelStyle;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BpmdiPackage.BPMN_DIAGRAM__PLANE:
				return basicSetPlane(null, msgs);
			case BpmdiPackage.BPMN_DIAGRAM__LABEL_STYLE:
