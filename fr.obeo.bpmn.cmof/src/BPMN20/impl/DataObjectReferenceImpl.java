 ...
 * <ul>
 *   <li>{@link BPMN20.impl.DataObjectReferenceImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link BPMN20.impl.DataObjectReferenceImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link BPMN20.impl.DataObjectReferenceImpl#getDataObjectRef <em>Data Object Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataObjectReferenceImpl extends FlowElementImpl implements DataObjectReference {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getDataObjectReference();
	}
		...
		if (itemSubjectRef != null && itemSubjectRef.eIsProxy()) {
			...
			if (itemSubjectRef != oldItemSubjectRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.DATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
			}
		}
	...
	public void setItemSubjectRef(ItemDefinition newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.DATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public NotificationChain basicSetDataState(DataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(DataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE, newDataState, newDataState));
	}
	...
	public DataObject getDataObjectRef() {
		if (dataObjectRef != null && dataObjectRef.eIsProxy()) {
			...
			if (dataObjectRef != oldDataObjectRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.DATA_OBJECT_REFERENCE__DATA_OBJECT_REF, oldDataObjectRef, dataObjectRef));
			}
		}
	...
	public void setDataObjectRef(DataObject newDataObjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.DATA_OBJECT_REFERENCE__DATA_OBJECT_REF, oldDataObjectRef, dataObjectRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.DATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF:
				if (resolve) return getItemSubjectRef();
				return basicGetItemSubjectRef();
			case BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE:
				return getDataState();
			case BPMN20Package.DATA_OBJECT_REFERENCE__DATA_OBJECT_REF:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ItemAwareElement.class) {
			switch (derivedFeatureID) {
				case BPMN20Package.DATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF: return BPMN20Package.ITEM_AWARE_ELEMENT__ITEM_SUBJECT_REF;
				case BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE: return BPMN20Package.ITEM_AWARE_ELEMENT__DATA_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ItemAwareElement.class) {
			switch (baseFeatureID) {
				case BPMN20Package.ITEM_AWARE_ELEMENT__ITEM_SUBJECT_REF: return BPMN20Package.DATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF;
				case BPMN20Package.ITEM_AWARE_ELEMENT__DATA_STATE: return BPMN20Package.DATA_OBJECT_REFERENCE__DATA_STATE;
				default: return -1;
			}
		}
