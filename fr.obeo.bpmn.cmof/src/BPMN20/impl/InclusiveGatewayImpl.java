 ...
 * <ul>
 *   <li>{@link BPMN20.impl.InclusiveGatewayImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveGatewayImpl extends GatewayImpl implements InclusiveGateway {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getInclusiveGateway();
	}
		...
		if (default_ != null && default_.eIsProxy()) {
			...
			if (default_ != oldDefault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.INCLUSIVE_GATEWAY__DEFAULT, oldDefault, default_));
			}
		}
		return default_;
	}
	...
	public void setDefault(SequenceFlow newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.INCLUSIVE_GATEWAY__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.INCLUSIVE_GATEWAY__DEFAULT:
