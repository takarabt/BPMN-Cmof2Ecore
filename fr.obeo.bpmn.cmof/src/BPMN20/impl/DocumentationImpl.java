 ...
 * <ul>
 *   <li>{@link BPMN20.impl.DocumentationImpl#getText <em>Text</em>}</li>
 *   <li>{@link BPMN20.impl.DocumentationImpl#getTextFormat <em>Text Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentationImpl extends BaseElementImpl implements Documentation {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getDocumentation();
	}
	...
	public void setText(Object newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.DOCUMENTATION__TEXT, oldText, text));
	}
	...
	public void setTextFormat(String newTextFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.DOCUMENTATION__TEXT_FORMAT, oldTextFormat, textFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.DOCUMENTATION__TEXT:
				return getText();
			case BPMN20Package.DOCUMENTATION__TEXT_FORMAT:
