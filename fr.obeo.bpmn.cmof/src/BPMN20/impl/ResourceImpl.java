 ...
 * <ul>
 *   <li>{@link BPMN20.impl.ResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link BPMN20.impl.ResourceImpl#getResourceParameters <em>Resource Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends RootElementImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getResource();
	}
	...
	public void setName(Object newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.RESOURCE__NAME, oldName, name));
	}
	...
	public EList<ResourceParameter> getResourceParameters() {
		if (resourceParameters == null) {
			resourceParameters = new EObjectContainmentEList<ResourceParameter>(ResourceParameter.class, this, BPMN20Package.RESOURCE__RESOURCE_PARAMETERS);
		}
