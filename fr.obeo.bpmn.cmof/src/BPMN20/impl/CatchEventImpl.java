 ...
 * <ul>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getParallelMultiple <em>Parallel Multiple</em>}</li>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getOutputSet <em>Output Set</em>}</li>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getEventDefinitionRefs <em>Event Definition Refs</em>}</li>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getDataOutputAssociation <em>Data Output Association</em>}</li>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getDataOutputs <em>Data Outputs</em>}</li>
 *   <li>{@link BPMN20.impl.CatchEventImpl#getEventDefinitions <em>Event Definitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CatchEventImpl extends EventImpl implements CatchEvent {
	 ...
	 * @ordered
	 */
	protected static final Object PARALLEL_MULTIPLE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object parallelMultiple = PARALLEL_MULTIPLE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getCatchEvent();
	}
	 ...
	 * @generated
	 */
	public Object getParallelMultiple() {
	 ...
	 * @generated
	 */
	public void setParallelMultiple(Object newParallelMultiple) {
		Object oldParallelMultiple = parallelMultiple;
		parallelMultiple = newParallelMultiple;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.CATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple, parallelMultiple));
	}
	...
	public NotificationChain basicSetOutputSet(OutputSet newOutputSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN20Package.CATCH_EVENT__OUTPUT_SET, oldOutputSet, newOutputSet);
	...
	public void setOutputSet(OutputSet newOutputSet) {
		if (newOutputSet != outputSet) {
			...
			if (outputSet != null)
				msgs = ((InternalEObject)outputSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.CATCH_EVENT__OUTPUT_SET, null, msgs);
			if (newOutputSet != null)
				msgs = ((InternalEObject)newOutputSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.CATCH_EVENT__OUTPUT_SET, null, msgs);
			msgs = basicSetOutputSet(newOutputSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.CATCH_EVENT__OUTPUT_SET, newOutputSet, newOutputSet));
	}
	...
	public EList<EventDefinition> getEventDefinitionRefs() {
		if (eventDefinitionRefs == null) {
			eventDefinitionRefs = new EObjectResolvingEList<EventDefinition>(EventDefinition.class, this, BPMN20Package.CATCH_EVENT__EVENT_DEFINITION_REFS);
		}
	...
	public EList<DataOutputAssociation> getDataOutputAssociation() {
		if (dataOutputAssociation == null) {
			dataOutputAssociation = new EObjectContainmentEList<DataOutputAssociation>(DataOutputAssociation.class, this, BPMN20Package.CATCH_EVENT__DATA_OUTPUT_ASSOCIATION);
		}
	...
	public EList<DataOutput> getDataOutputs() {
		if (dataOutputs == null) {
			dataOutputs = new EObjectContainmentEList<DataOutput>(DataOutput.class, this, BPMN20Package.CATCH_EVENT__DATA_OUTPUTS);
		}
		return dataOutputs;
	}
	...
	public EList<EventDefinition> getEventDefinitions() {
		if (eventDefinitions == null) {
			eventDefinitions = new EObjectContainmentEList<EventDefinition>(EventDefinition.class, this, BPMN20Package.CATCH_EVENT__EVENT_DEFINITIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN20Package.CATCH_EVENT__OUTPUT_SET:
				return getOutputSet();
			case BPMN20Package.CATCH_EVENT__EVENT_DEFINITION_REFS:
