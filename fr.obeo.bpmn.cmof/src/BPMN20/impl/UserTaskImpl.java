 ...
 * <ul>
 *   <li>{@link BPMN20.impl.UserTaskImpl#getRenderings <em>Renderings</em>}</li>
 *   <li>{@link BPMN20.impl.UserTaskImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserTaskImpl extends TaskImpl implements UserTask {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getUserTask();
	}
	...
	public EList<Rendering> getRenderings() {
		if (renderings == null) {
			renderings = new EObjectContainmentEList<Rendering>(Rendering.class, this, BPMN20Package.USER_TASK__RENDERINGS);
		}
		return renderings;
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.USER_TASK__IMPLEMENTATION, oldImplementation, implementation));
	}
