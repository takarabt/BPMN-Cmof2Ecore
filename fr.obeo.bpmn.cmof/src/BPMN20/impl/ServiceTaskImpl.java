 ...
 * <ul>
 *   <li>{@link BPMN20.impl.ServiceTaskImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link BPMN20.impl.ServiceTaskImpl#getOperationRef <em>Operation Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceTaskImpl extends TaskImpl implements ServiceTask {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getServiceTask();
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.SERVICE_TASK__IMPLEMENTATION, oldImplementation, implementation));
	}
	...
	public Operation getOperationRef() {
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.SERVICE_TASK__OPERATION_REF, oldOperationRef, operationRef));
			}
		}
		return operationRef;
	}
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.SERVICE_TASK__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN20Package.SERVICE_TASK__OPERATION_REF:
