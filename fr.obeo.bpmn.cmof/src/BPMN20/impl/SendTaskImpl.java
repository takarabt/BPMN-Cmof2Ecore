 ...
 * <ul>
 *   <li>{@link BPMN20.impl.SendTaskImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link BPMN20.impl.SendTaskImpl#getOperationRef <em>Operation Ref</em>}</li>
 *   <li>{@link BPMN20.impl.SendTaskImpl#getMessageRef <em>Message Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendTaskImpl extends TaskImpl implements SendTask {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getSendTask();
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.SEND_TASK__IMPLEMENTATION, oldImplementation, implementation));
	}
	...
	public Operation getOperationRef() {
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.SEND_TASK__OPERATION_REF, oldOperationRef, operationRef));
			}
		}
		return operationRef;
	}
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.SEND_TASK__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public Message getMessageRef() {
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.SEND_TASK__MESSAGE_REF, oldMessageRef, messageRef));
			}
		}
		return messageRef;
	}
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.SEND_TASK__MESSAGE_REF, oldMessageRef, messageRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN20Package.SEND_TASK__OPERATION_REF:
				if (resolve) return getOperationRef();
				return basicGetOperationRef();
			case BPMN20Package.SEND_TASK__MESSAGE_REF:
