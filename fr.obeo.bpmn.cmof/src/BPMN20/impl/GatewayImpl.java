 ...
 * <ul>
 *   <li>{@link BPMN20.impl.GatewayImpl#getGatewayDirection <em>Gateway Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class GatewayImpl extends FlowNodeImpl implements Gateway {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getGateway();
	}
	...
	public void setGatewayDirection(GatewayDirection newGatewayDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.GATEWAY__GATEWAY_DIRECTION, oldGatewayDirection, gatewayDirection));
	}
