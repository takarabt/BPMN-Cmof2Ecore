 ...
 * <ul>
 *   <li>{@link BPMN20.impl.ThrowEventImpl#getInputSet <em>Input Set</em>}</li>
 *   <li>{@link BPMN20.impl.ThrowEventImpl#getEventDefinitionRefs <em>Event Definition Refs</em>}</li>
 *   <li>{@link BPMN20.impl.ThrowEventImpl#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link BPMN20.impl.ThrowEventImpl#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link BPMN20.impl.ThrowEventImpl#getEventDefinitions <em>Event Definitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ThrowEventImpl extends EventImpl implements ThrowEvent {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getThrowEvent();
	}
	...
	public NotificationChain basicSetInputSet(InputSet newInputSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN20Package.THROW_EVENT__INPUT_SET, oldInputSet, newInputSet);
	...
	public void setInputSet(InputSet newInputSet) {
		if (newInputSet != inputSet) {
			...
			if (inputSet != null)
				msgs = ((InternalEObject)inputSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.THROW_EVENT__INPUT_SET, null, msgs);
			if (newInputSet != null)
				msgs = ((InternalEObject)newInputSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN20Package.THROW_EVENT__INPUT_SET, null, msgs);
			msgs = basicSetInputSet(newInputSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.THROW_EVENT__INPUT_SET, newInputSet, newInputSet));
	}
	...
	public EList<EventDefinition> getEventDefinitionRefs() {
		if (eventDefinitionRefs == null) {
			eventDefinitionRefs = new EObjectResolvingEList<EventDefinition>(EventDefinition.class, this, BPMN20Package.THROW_EVENT__EVENT_DEFINITION_REFS);
		}
	...
	public EList<DataInputAssociation> getDataInputAssociation() {
		if (dataInputAssociation == null) {
			dataInputAssociation = new EObjectContainmentEList<DataInputAssociation>(DataInputAssociation.class, this, BPMN20Package.THROW_EVENT__DATA_INPUT_ASSOCIATION);
		}
	...
	public EList<DataInput> getDataInputs() {
		if (dataInputs == null) {
			dataInputs = new EObjectContainmentEList<DataInput>(DataInput.class, this, BPMN20Package.THROW_EVENT__DATA_INPUTS);
		}
		return dataInputs;
	}
	...
	public EList<EventDefinition> getEventDefinitions() {
		if (eventDefinitions == null) {
			eventDefinitions = new EObjectContainmentEList<EventDefinition>(EventDefinition.class, this, BPMN20Package.THROW_EVENT__EVENT_DEFINITIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN20Package.THROW_EVENT__INPUT_SET:
				return basicSetInputSet(null, msgs);
			case BPMN20Package.THROW_EVENT__DATA_INPUT_ASSOCIATION:
				return ((InternalEList<?>)getDataInputAssociation()).basicRemove(otherEnd, msgs);
			case BPMN20Package.THROW_EVENT__DATA_INPUTS:
				return ((InternalEList<?>)getDataInputs()).basicRemove(otherEnd, msgs);
			case BPMN20Package.THROW_EVENT__EVENT_DEFINITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.THROW_EVENT__INPUT_SET:
				return getInputSet();
			case BPMN20Package.THROW_EVENT__EVENT_DEFINITION_REFS:
