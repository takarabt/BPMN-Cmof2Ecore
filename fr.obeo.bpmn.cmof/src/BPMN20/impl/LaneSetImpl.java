 ...
 * <ul>
 *   <li>{@link BPMN20.impl.LaneSetImpl#getLanes <em>Lanes</em>}</li>
 *   <li>{@link BPMN20.impl.LaneSetImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LaneSetImpl extends BaseElementImpl implements LaneSet {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getLaneSet();
	}
	...
	public EList<Lane> getLanes() {
		if (lanes == null) {
			lanes = new EObjectContainmentEList<Lane>(Lane.class, this, BPMN20Package.LANE_SET__LANES);
		}
		return lanes;
	}
	...
	public void setName(Object newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.LANE_SET__NAME, oldName, name));
	}
