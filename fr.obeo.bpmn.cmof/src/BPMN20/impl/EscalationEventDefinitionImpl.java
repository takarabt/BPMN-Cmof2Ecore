 ...
 * <ul>
 *   <li>{@link BPMN20.impl.EscalationEventDefinitionImpl#getEscalationRef <em>Escalation Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EscalationEventDefinitionImpl extends EventDefinitionImpl implements EscalationEventDefinition {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getEscalationEventDefinition();
	}
		...
		if (escalationRef != null && escalationRef.eIsProxy()) {
			...
			if (escalationRef != oldEscalationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, oldEscalationRef, escalationRef));
			}
		}
	...
	public void setEscalationRef(Escalation newEscalationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, oldEscalationRef, escalationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF:
