 ...
 * <ul>
 *   <li>{@link BPMN20.impl.StartEventImpl#isIsInterrupting <em>Is Interrupting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StartEventImpl extends CatchEventImpl implements StartEvent {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getStartEvent();
	}
	...
	public void setIsInterrupting(boolean newIsInterrupting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.START_EVENT__IS_INTERRUPTING, oldIsInterrupting, isInterrupting));
	}
