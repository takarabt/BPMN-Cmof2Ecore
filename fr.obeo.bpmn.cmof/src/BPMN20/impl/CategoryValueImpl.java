 ...
 * <ul>
 *   <li>{@link BPMN20.impl.CategoryValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link BPMN20.impl.CategoryValueImpl#getCategorizedFlowElements <em>Categorized Flow Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CategoryValueImpl extends BaseElementImpl implements CategoryValue {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getCategoryValue();
	}
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.CATEGORY_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.CATEGORY_VALUE__VALUE:
				return getValue();
			case BPMN20Package.CATEGORY_VALUE__CATEGORIZED_FLOW_ELEMENTS:
