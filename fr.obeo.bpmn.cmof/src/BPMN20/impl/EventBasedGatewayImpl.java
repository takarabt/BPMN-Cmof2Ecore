 ...
 * <ul>
 *   <li>{@link BPMN20.impl.EventBasedGatewayImpl#isInstantiate <em>Instantiate</em>}</li>
 *   <li>{@link BPMN20.impl.EventBasedGatewayImpl#getEventGatewayType <em>Event Gateway Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventBasedGatewayImpl extends GatewayImpl implements EventBasedGateway {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getEventBasedGateway();
	}
	...
	public void setInstantiate(boolean newInstantiate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.EVENT_BASED_GATEWAY__INSTANTIATE, oldInstantiate, instantiate));
	}
	...
	public void setEventGatewayType(EventBasedGatewayType newEventGatewayType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, oldEventGatewayType, eventGatewayType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.EVENT_BASED_GATEWAY__INSTANTIATE:
				return isInstantiate();
			case BPMN20Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE:
