 ...
 * <ul>
 *   <li>{@link BPMN20.impl.CorrelationKeyImpl#getCorrelationPropertyRef <em>Correlation Property Ref</em>}</li>
 *   <li>{@link BPMN20.impl.CorrelationKeyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CorrelationKeyImpl extends BaseElementImpl implements CorrelationKey {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getCorrelationKey();
	}
	...
	public EList<CorrelationProperty> getCorrelationPropertyRef() {
		if (correlationPropertyRef == null) {
			correlationPropertyRef = new EObjectResolvingEList<CorrelationProperty>(CorrelationProperty.class, this, BPMN20Package.CORRELATION_KEY__CORRELATION_PROPERTY_REF);
		}
	...
	public void setName(Object newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.CORRELATION_KEY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.CORRELATION_KEY__CORRELATION_PROPERTY_REF:
