 ...
 * <ul>
 *   <li>{@link BPMN20.impl.ItemDefinitionImpl#getItemKind <em>Item Kind</em>}</li>
 *   <li>{@link BPMN20.impl.ItemDefinitionImpl#getStructureRef <em>Structure Ref</em>}</li>
 *   <li>{@link BPMN20.impl.ItemDefinitionImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link BPMN20.impl.ItemDefinitionImpl#getImport <em>Import</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ItemDefinitionImpl extends RootElementImpl implements ItemDefinition {
	...
	protected EClass eStaticClass() {
		return BPMN20Package.eINSTANCE.getItemDefinition();
	}
	...
	public void setItemKind(ItemKind newItemKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.ITEM_DEFINITION__ITEM_KIND, oldItemKind, itemKind));
	}
	...
	public EObject getStructureRef() {
		if (structureRef != null && structureRef.eIsProxy()) {
			...
			if (structureRef != oldStructureRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.ITEM_DEFINITION__STRUCTURE_REF, oldStructureRef, structureRef));
			}
		}
		return structureRef;
	}
	...
	public void setStructureRef(EObject newStructureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.ITEM_DEFINITION__STRUCTURE_REF, oldStructureRef, structureRef));
	}
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.ITEM_DEFINITION__IS_COLLECTION, oldIsCollection, isCollection));
	}
	...
	public Import getImport() {
		if (import_ != null && import_.eIsProxy()) {
			...
			if (import_ != oldImport) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN20Package.ITEM_DEFINITION__IMPORT, oldImport, import_));
			}
		}
		return import_;
	}
	...
	public void setImport(Import newImport) {
		...
		import_ = newImport;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN20Package.ITEM_DEFINITION__IMPORT, oldImport, import_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN20Package.ITEM_DEFINITION__ITEM_KIND:
				return getItemKind();
			case BPMN20Package.ITEM_DEFINITION__STRUCTURE_REF:
				if (resolve) return getStructureRef();
				return basicGetStructureRef();
			case BPMN20Package.ITEM_DEFINITION__IS_COLLECTION:
				return isIsCollection();
			case BPMN20Package.ITEM_DEFINITION__IMPORT:
