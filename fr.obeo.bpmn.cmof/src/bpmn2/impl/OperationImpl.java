 ...
 * <ul>
 *   <li>{@link bpmn2.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmn2.impl.OperationImpl#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link bpmn2.impl.OperationImpl#getOutMessageRef <em>Out Message Ref</em>}</li>
 *   <li>{@link bpmn2.impl.OperationImpl#getErrorRefs <em>Error Refs</em>}</li>
 *   <li>{@link bpmn2.impl.OperationImpl#getImplementationRef <em>Implementation Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends BaseElementImpl implements Operation {
	 ...
	 * @ordered
	 */
	protected EList<bpmn2.Error> errorRefs;
	 ...
	 * @generated
	 */
	public EList<bpmn2.Error> getErrorRefs() {
		if (errorRefs == null) {
			errorRefs = new EObjectResolvingEList<bpmn2.Error>(bpmn2.Error.class, this, Bpmn2Package.OPERATION__ERROR_REFS);
		}
		return errorRefs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Bpmn2Package.OPERATION__ERROR_REFS:
				getErrorRefs().clear();
				getErrorRefs().addAll((Collection<? extends bpmn2.Error>)newValue);
				return;
			case Bpmn2Package.OPERATION__IMPLEMENTATION_REF:
