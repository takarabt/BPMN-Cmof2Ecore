 ...
 * <ul>
 *   <li>{@link bpmn2.impl.DataAssociationImpl#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link bpmn2.impl.DataAssociationImpl#getAssignment <em>Assignment</em>}</li>
 *   <li>{@link bpmn2.impl.DataAssociationImpl#getTargetRef <em>Target Ref</em>}</li>
 *   <li>{@link bpmn2.impl.DataAssociationImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataAssociationImpl extends BaseElementImpl implements DataAssociation {
	...
	public ItemAwareElement getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2Package.DATA_ASSOCIATION__TARGET_REF, oldTargetRef, targetRef));
			}
		}
		return targetRef;
	}
	...
	public EList<ItemAwareElement> getSourceRef() {
		if (sourceRef == null) {
			sourceRef = new EObjectResolvingEList<ItemAwareElement>(ItemAwareElement.class, this, Bpmn2Package.DATA_ASSOCIATION__SOURCE_REF);
		}
		return sourceRef;
	}
