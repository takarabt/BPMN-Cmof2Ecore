 ...
 * <ul>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getIncomingConversationLinks <em>Incoming Conversation Links</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getOutgoingConversationLinks <em>Outgoing Conversation Links</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getInterfaceRefs <em>Interface Refs</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getParticipantMultiplicity <em>Participant Multiplicity</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getEndPointRefs <em>End Point Refs</em>}</li>
 *   <li>{@link bpmn2.impl.ParticipantImpl#getProcessRef <em>Process Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParticipantImpl extends BaseElementImpl implements Participant {
	 ...
	 * @ordered
	 */
	protected bpmn2.Process processRef;
	 ...
	 * @generated
	 */
	public bpmn2.Process basicGetProcessRef() {
		return processRef;
	}
	 ...
	 * @generated
	 */
	public void setProcessRef(bpmn2.Process newProcessRef) {
		bpmn2.Process oldProcessRef = processRef;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Bpmn2Package.PARTICIPANT__END_POINT_REFS:
				...
				return;
			case Bpmn2Package.PARTICIPANT__PROCESS_REF:
				setProcessRef((bpmn2.Process)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Bpmn2Package.PARTICIPANT__END_POINT_REFS:
				...
				return;
			case Bpmn2Package.PARTICIPANT__PROCESS_REF:
				setProcessRef((bpmn2.Process)null);
				return;
		}
