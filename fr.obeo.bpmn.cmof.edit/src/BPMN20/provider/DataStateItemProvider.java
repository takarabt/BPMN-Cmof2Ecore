...
/**
 * This is the item provider adapter for a {@link BPMN20.DataState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataStateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataState_name_feature", "_UI_DataState_type"),
				 BPMN20Package.eINSTANCE.getDataState_Name(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((DataState)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DataState_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataState.class)) {
			case BPMN20Package.DATA_STATE__NAME:
