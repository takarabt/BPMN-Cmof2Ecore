...
/**
 * This is the item provider adapter for a {@link BPMN20.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_structureRef_feature", "_UI_Signal_type"),
				 BPMN20Package.eINSTANCE.getSignal_StructureRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getSignal_Name(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((Signal)object).getName();
