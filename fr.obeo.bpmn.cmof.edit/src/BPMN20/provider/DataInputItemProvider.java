...
/**
 * This is the item provider adapter for a {@link BPMN20.DataInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataInputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataInput_name_feature", "_UI_DataInput_type"),
				 BPMN20Package.eINSTANCE.getDataInput_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataInput_isCollection_feature", "_UI_DataInput_type"),
				 BPMN20Package.eINSTANCE.getDataInput_IsCollection(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataInput_inputSetWithOptional_feature", "_UI_DataInput_type"),
				 BPMN20Package.eINSTANCE.getDataInput_InputSetWithOptional(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataInput_inputSetWithWhileExecuting_feature", "_UI_DataInput_type"),
				 BPMN20Package.eINSTANCE.getDataInput_InputSetWithWhileExecuting(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataInput_inputSetRefs_feature", "_UI_DataInput_type"),
				 BPMN20Package.eINSTANCE.getDataInput_InputSetRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataInput"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((DataInput)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DataInput_type") :
