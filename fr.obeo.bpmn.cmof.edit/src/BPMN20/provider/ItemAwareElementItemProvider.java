...
/**
 * This is the item provider adapter for a {@link BPMN20.ItemAwareElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemAwareElementItemProvider
	...
	/**
	 * This returns ItemAwareElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ItemAwareElement"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((ItemAwareElement)object).getId();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ItemAwareElement_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ItemAwareElement.class)) {
			case BPMN20Package.ITEM_AWARE_ELEMENT__DATA_STATE:
