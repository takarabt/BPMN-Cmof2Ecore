...
/**
 * This is the item provider adapter for a {@link BPMN20.ThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrowEventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getThrowEvent_EventDefinitionRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getThrowEvent_InputSet());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getThrowEvent_DataInputAssociation());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getThrowEvent_DataInputs());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getThrowEvent_EventDefinitions());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((ThrowEvent)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getThrowEvent_InputSet(),
				 BPMN20Factory.eINSTANCE.createInputSet()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getThrowEvent_DataInputAssociation(),
				 BPMN20Factory.eINSTANCE.createDataInputAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getThrowEvent_DataInputs(),
				 BPMN20Factory.eINSTANCE.createDataInput()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getThrowEvent_EventDefinitions(),
