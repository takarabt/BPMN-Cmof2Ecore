...
/**
 * This is the item provider adapter for a {@link BPMN20.EventBasedGateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventBasedGatewayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getEventBasedGateway_Instantiate(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getEventBasedGateway_EventGatewayType(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((EventBasedGateway)object).getName();
