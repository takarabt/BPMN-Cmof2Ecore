...
/**
 * This is the item provider adapter for a {@link BPMN20.FlowElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getFlowElement_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowElement_categoryValueRef_feature", "_UI_FlowElement_type"),
				 BPMN20Package.eINSTANCE.getFlowElement_CategoryValueRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getFlowElement_Auditing());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getFlowElement_Monitoring());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((FlowElement)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getFlowElement_Auditing(),
				 BPMN20Factory.eINSTANCE.createAuditing()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getFlowElement_Monitoring(),
