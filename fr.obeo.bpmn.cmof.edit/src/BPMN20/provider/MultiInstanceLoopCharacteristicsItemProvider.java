...
/**
 * This is the item provider adapter for a {@link BPMN20.MultiInstanceLoopCharacteristics} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiInstanceLoopCharacteristicsItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_IsSequential(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_Behavior(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_LoopDataInputRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_LoopDataOutputRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_OneBehaviorEventRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_NoneBehaviorEventRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_LoopCardinality());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_InputDataItem());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_OutputDataItem());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_CompletionCondition());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_ComplexBehaviorDefinition());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((MultiInstanceLoopCharacteristics)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_LoopCardinality(),
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_InputDataItem(),
				 BPMN20Factory.eINSTANCE.createDataInput()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_OutputDataItem(),
				 BPMN20Factory.eINSTANCE.createDataOutput()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_CompletionCondition(),
				 BPMN20Factory.eINSTANCE.createExpression()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_ComplexBehaviorDefinition(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_LoopCardinality() ||
			childFeature == BPMN20Package.eINSTANCE.getMultiInstanceLoopCharacteristics_CompletionCondition();
