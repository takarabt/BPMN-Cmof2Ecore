...
/**
 * This is the item provider adapter for a {@link BPMN20.ResourceParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceParameter_name_feature", "_UI_ResourceParameter_type"),
				 BPMN20Package.eINSTANCE.getResourceParameter_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getResourceParameter_IsRequired(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceParameter_type_feature", "_UI_ResourceParameter_type"),
				 BPMN20Package.eINSTANCE.getResourceParameter_Type(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Object labelValue = ((ResourceParameter)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ResourceParameter_type") :
