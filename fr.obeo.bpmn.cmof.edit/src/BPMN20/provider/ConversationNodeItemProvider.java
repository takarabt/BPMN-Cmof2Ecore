...
/**
 * This is the item provider adapter for a {@link BPMN20.ConversationNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConversationNodeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConversationNode_name_feature", "_UI_ConversationNode_type"),
				 BPMN20Package.eINSTANCE.getConversationNode_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConversationNode_participantRefs_feature", "_UI_ConversationNode_type"),
				 BPMN20Package.eINSTANCE.getConversationNode_ParticipantRefs(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConversationNode_messageFlowRefs_feature", "_UI_ConversationNode_type"),
				 BPMN20Package.eINSTANCE.getConversationNode_MessageFlowRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getConversationNode_CorrelationKeys());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((ConversationNode)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ConversationNode_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getConversationNode_CorrelationKeys(),
