...
/**
 * This is the item provider adapter for a {@link BPMN20.StartEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartEventItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsInterruptingPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Is Interrupting feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StartEvent_isInterrupting_feature", "_UI_StartEvent_type"),
				 BPMN20Package.eINSTANCE.getStartEvent_IsInterrupting(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((StartEvent)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StartEvent.class)) {
			case BPMN20Package.START_EVENT__IS_INTERRUPTING:
