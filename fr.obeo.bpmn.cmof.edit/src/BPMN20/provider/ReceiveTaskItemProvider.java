...
/**
 * This is the item provider adapter for a {@link BPMN20.ReceiveTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReceiveTaskItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReceiveTask_implementation_feature", "_UI_ReceiveTask_type"),
				 BPMN20Package.eINSTANCE.getReceiveTask_Implementation(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReceiveTask_instantiate_feature", "_UI_ReceiveTask_type"),
				 BPMN20Package.eINSTANCE.getReceiveTask_Instantiate(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReceiveTask_operationRef_feature", "_UI_ReceiveTask_type"),
				 BPMN20Package.eINSTANCE.getReceiveTask_OperationRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReceiveTask_messageRef_feature", "_UI_ReceiveTask_type"),
				 BPMN20Package.eINSTANCE.getReceiveTask_MessageRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReceiveTask"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((ReceiveTask)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ReceiveTask_type") :
