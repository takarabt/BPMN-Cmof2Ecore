...
/**
 * This is the item provider adapter for a {@link BPMN20.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN20Package.eINSTANCE.getResource_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getResource_ResourceParameters());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((Resource)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Resource.class)) {
			case BPMN20Package.RESOURCE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case BPMN20Package.RESOURCE__RESOURCE_PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getResource_ResourceParameters(),
