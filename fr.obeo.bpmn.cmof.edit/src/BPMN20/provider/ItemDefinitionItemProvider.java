...
/**
 * This is the item provider adapter for a {@link BPMN20.ItemDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemDefinitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_itemKind_feature", "_UI_ItemDefinition_type"),
				 BPMN20Package.eINSTANCE.getItemDefinition_ItemKind(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_structureRef_feature", "_UI_ItemDefinition_type"),
				 BPMN20Package.eINSTANCE.getItemDefinition_StructureRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_isCollection_feature", "_UI_ItemDefinition_type"),
				 BPMN20Package.eINSTANCE.getItemDefinition_IsCollection(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_import_feature", "_UI_ItemDefinition_type"),
				 BPMN20Package.eINSTANCE.getItemDefinition_Import(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Object labelValue = ((ItemDefinition)object).getId();
