...
/**
 * This is the item provider adapter for a {@link BPMN20.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getAssignment_From());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getAssignment_To());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((Assignment)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getAssignment_From(),
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getAssignment_To(),
				 BPMN20Factory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == BPMN20Package.eINSTANCE.getAssignment_From() ||
			childFeature == BPMN20Package.eINSTANCE.getAssignment_To();
