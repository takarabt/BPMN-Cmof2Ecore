...
/**
 * This is the item provider adapter for a {@link BPMN20.InputOutputSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputOutputSpecificationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN20Package.eINSTANCE.getInputOutputSpecification_InputSets());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getInputOutputSpecification_OutputSets());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getInputOutputSpecification_DataInputs());
			childrenFeatures.add(BPMN20Package.eINSTANCE.getInputOutputSpecification_DataOutputs());
		}
	...
	public String getText(Object object) {
		Object labelValue = ((InputOutputSpecification)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getInputOutputSpecification_InputSets(),
				 BPMN20Factory.eINSTANCE.createInputSet()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getInputOutputSpecification_OutputSets(),
				 BPMN20Factory.eINSTANCE.createOutputSet()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getInputOutputSpecification_DataInputs(),
				 BPMN20Factory.eINSTANCE.createDataInput()));

		newChildDescriptors.add
			(createChildParameter
				(BPMN20Package.eINSTANCE.getInputOutputSpecification_DataOutputs(),
