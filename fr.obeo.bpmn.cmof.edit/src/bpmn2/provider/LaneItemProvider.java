...
/**
 * This is the item provider adapter for a {@link bpmn2.Lane} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LaneItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getLane_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getLane_PartitionElementRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getLane_FlowNodeRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getLane_ChildLaneSet());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getLane_PartitionElement());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getLane_ChildLaneSet(),
				 Bpmn2Factory.eINSTANCE.createLaneSet()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getLane_PartitionElement(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Bpmn2Package.eINSTANCE.getBaseElement_Documentation() ||
			childFeature == Bpmn2Package.eINSTANCE.getLane_PartitionElement() ||
			childFeature == Bpmn2Package.eINSTANCE.getLane_ChildLaneSet();
