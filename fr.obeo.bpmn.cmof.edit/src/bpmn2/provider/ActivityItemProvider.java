...
/**
 * This is the item provider adapter for a {@link bpmn2.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getActivity_IsForCompensation(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getActivity_Default(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getActivity_BoundaryEventRefs(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getActivity_StartQuantity(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getActivity_CompletionQuantity(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_LoopCharacteristics());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_Resources());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_Properties());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_IoSpecification());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_DataInputAssociations());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getActivity_DataOutputAssociations());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getActivity_Resources(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getActivity_Properties(),
				 Bpmn2Factory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getActivity_IoSpecification(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getActivity_DataOutputAssociations(),
