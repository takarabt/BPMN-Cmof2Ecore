...
/**
 * This is the item provider adapter for a {@link bpmn2.Error} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getError_StructureRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((bpmn2.Error)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(bpmn2.Error.class)) {
