...
/**
 * This is the item provider adapter for a {@link bpmn2.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getAssignment_From());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getAssignment_To());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getAssignment_From(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getAssignment_To(),
				 Bpmn2Factory.eINSTANCE.createExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Bpmn2Package.eINSTANCE.getAssignment_From() ||
			childFeature == Bpmn2Package.eINSTANCE.getAssignment_To();
