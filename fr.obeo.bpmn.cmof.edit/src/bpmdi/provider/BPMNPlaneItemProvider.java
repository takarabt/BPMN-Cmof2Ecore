...
import di.provider.PlaneItemProvider;
...
/**
 * This is the item provider adapter for a {@link bpmdi.BPMNPlane} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPMNPlaneItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmdiPackage.Literals.BPMN_PLANE__BPMN_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_BPMNPlane_type");
	}
